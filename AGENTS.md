...
This project is indexed by GitNexus as **PyEIDORS** (18749 symbols, 35201 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
