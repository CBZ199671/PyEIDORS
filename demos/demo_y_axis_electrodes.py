...
def demo_y_axis_electrodes():
    ...
    for i, (name, config) in enumerate(configs):
        ...
        for j in range(len(centers_x)):
            ...
            ax.plot(
                [centers_x[j], centers_x[next_j]],
                [centers_y[j], centers_y[next_j]],
                "g--",
                alpha=0.3,
                linewidth=1,
            )
    ...
    print(
        "✅ Y-axis electrode position demo complete, saved as y_axis_electrode_demo.png"
    )
...
def demo_before_after_comparison():
    ...
    ax1.arrow(
        0, 0, 1.2, 0, head_width=0.05, head_length=0.05, fc="red", ec="red", alpha=0.7
    )
    ...
    # Mark positive Y-axis
    ax2.arrow(
        0, 0, 0, 1.2, head_width=0.05, head_length=0.05, fc="red", ec="red", alpha=0.7
    )
    ...
    print(
        "✅ Before/after comparison demo complete, saved as electrode_position_comparison.png"
    )
...
def run_demo():
    ...
    try:
        ...
        print(
            "   - y_axis_electrode_demo.png: Y-axis starting electrode configuration demo"
        )
