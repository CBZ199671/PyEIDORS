...
This project is indexed by GitNexus as **PyEIDORS** (16584 symbols, 33006 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
