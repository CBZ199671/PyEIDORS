...
Regularization implementations may depend on SciPy, DOLFINx, or Jacobian
calculators.  Keep package import light and resolve concrete classes on demand.
"""
...
_EXPORT_GROUPS: dict[str, tuple[str, ...]] = {
    ".base_regularization": ("BaseRegularization",),
    ".smoothness": (
...
_SUBMODULE_NAMES = frozenset({"base_regularization", "smoothness"})
