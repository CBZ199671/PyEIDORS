...
| V50 | 3D GREIT current status: T40..T45 done: source-map fixture, `GREIT3D_distribution`, finite-target `vh/vi`, `desired_solution_fn`/`D`, `calc_GREIT_RM` core, NF/image-SNR scalar-weight search. Still NOT EIDORS-complete: no HDF5 `keep_model_components`/cache schema, no official MATLAB parity gate, no common-config warmup, no final 48e/5936 parity benchmark. Linearized RM (`Y=T@J.T`, `D≈T`) remains explicit non-parity mode. Production "EIDORS同款" claim ! forbidden until V55..V65 + T40..T50 | src/pyeidors/inverse/greit.py; tests/unit/test_greit_rm.py; tests/unit/test_greit_calc_rm_parity.py; tests/unit/test_greit_noise_figure.py; reports/runtime_benchmarks/dual_model_rm_48e_5936_t36_20260422/summary.json; B11 |
